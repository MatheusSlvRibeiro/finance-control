...
const normalizeTransaction = (t: (typeof transactionsMock)[number]): Transaction => ({
	...t,
	type: toTransactionType(t.type),
})

const getNormalizedTransactions = (): Transaction[] => transactionsMock.map(normalizeTransaction)
